...
- [ ] Soft findings written down — a repairable defect on the **Bugs** list in `TODO.md`, an accepted limitation in the importer/scraper KDoc; a field the
  venue doesn't publish is not a bug (see `/importer-smoke` step 6)
