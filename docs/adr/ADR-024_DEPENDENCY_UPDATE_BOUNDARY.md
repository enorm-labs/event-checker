...
`RUFF_VERSION` in `validate-python.yml` joined as the ninth ([#1189](https://github.com/enorm-labs/event-junkie/issues/1189)). Four facts put them with Renovate rather than
