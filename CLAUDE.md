...
through [`.claude/rules/`](.claude/rules), which holds one symlink per topic — `architecture`, `kotlin`, `python`, `comments`, `design`, `documentation`, `markdown`, `testing`, `ci-cd`. Each
