 ...
 * why. Grouped by licence rather than listed flat: hundreds of alphabetical rows are a wall,
 * whereas "these are the MIT ones" is something a reader can actually use.
 *
